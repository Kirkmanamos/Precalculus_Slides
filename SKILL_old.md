...
1. **Minimize Dependencies** — Single HTML files with inline CSS/JS. No npm, no build tools.
...
5. **Accurate Math** - Graphs of functions need to be precise, and not loose representations. 
6. **Use Vue 
