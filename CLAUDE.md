...
**Next up:** Unit 1 complete (1.1–1.7); **Unit 2 complete (2.1–2.8)**; **Unit 3 complete (3.1–3.5)**; **Unit 4 sections 4.1–4.6b newly built or rebuilt to 5.5 standard** (the older `trig-review.html` is preserved as a legacy review deck). Pre-existing supplemental Rational Functions decks remain in place. Up next: rebuild the legacy 4.7/4.8 decks to the 5.5 standard, or move on to other supplemental review materials.
